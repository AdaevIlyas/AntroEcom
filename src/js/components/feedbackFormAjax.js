            ...
            .then((response) => {
              if (response.success) {
                ...
                if (form.classList.contains("main-order__form")) {
                  ...
                  document.querySelector(".main-order__success").style.display =
                    "flex";
                } else if (form.classList.contains("audit-form__form")) {
                  form.reset();
                  document
                    .querySelector(".js-modal-open[data-modal='thanks']")
                    .click();
                  ...
                  if (formData.has("application-userEmail"))
                    searchParams.append(
                      "email",
                      formData.get("application-userEmail")
                    );
                  if (formData.has("application-userTel"))
                    searchParams.append(
                      "phone",
                      formData.get("application-userTel")
                    );
                  if (formData.has("application-userComMethod"))
                    searchParams.append(
                      "send_to",
                      formData.get("application-userComMethod")
                    );
