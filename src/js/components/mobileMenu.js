export const mobileMenu = () => {
    ...
    if ( mobileMenu && burger ) {
        burger.addEventListener('click',function(){
            ...
            document.querySelector(".mobile-menu__black")?.classList.toggle("mobile-menu__black_show");
    ...
    if ( menuBlack && burger ) {
        menuBlack.addEventListener('mousedown',function(e){
            if ( e.target.classList.contains("mobile-menu__black_show") ) {   
                burger_toggle();
                document.querySelector('.mobile-menu__black_show')?.classList.remove('mobile-menu__black_show');
                document.querySelector('.mobile-menu__slide_open')?.classList.remove('mobile-menu__slide_open');
            }
        });
    }
